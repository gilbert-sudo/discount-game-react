...
const Newsletter = () => {
  ...
  return (
    <section className="bg-[#1a1a1a] dark:bg-gradient-to-r dark:from-[#35485E] dark:to-[#1f2937] border border-slate-800 dark:border-white/5 rounded-[3rem] p-8 sm:p-12 lg:p-16 relative overflow-hidden shadow-2xl mt-12 mb-12">
      {/* Dynamic Background Gradients */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden rounded-[3rem]">
        <div className="absolute top-[-20%] right-[-10%] w-[500px] h-[500px] bg-[#FF4D5A]/20 blur-[120px] rounded-full mix-blend-screen"></div>
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-12 lg:gap-16">
        ...
        <div className="lg:w-7/12 w-full">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            {/* Input & Button Group */}
            <div className="flex flex-col sm:flex-row gap-0 rounded-3xl sm:rounded-full overflow-hidden shadow-lg border border-white/20 focus-within:border-[#FF4D5A]/60 transition-colors">
              <input 
                type="email" 
            ...
            <label className="flex items-start gap-4 mt-4 cursor-pointer group">
              <div className="relative flex-shrink-0 mt-0.5">
                ...
                />
                <div className="w-5 h-5 border-2 border-slate-500 rounded-full bg-black/20 peer-checked:bg-[#FF4D5A] peer-checked:border-[#FF4D5A] transition-colors flex items-center justify-center">
