        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-12 h-12 rounded-full bg-slate-100 dark:bg-dark-hover flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-[#9900cc] dark:hover:text-[#c000ff] hover:bg-slate-200 dark:hover:bg-white/10 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium text-slate-500 dark:text-slate-400">
              <li><a href="#" className="hover:text-[#9900cc] dark:hover:text-[#c000ff] transition-colors">Protection Acheteur</a></li>
              <li><a href="#" className="hover:text-[#9900cc] dark:hover:text-[#c000ff] transition-colors">Livraison</a></li>
              <li><a href="#" className="hover:text-[#9900cc] dark:hover:text-[#c000ff] transition-colors">Suivi de commande</a></li>
              <li><a href="#" className="hover:text-[#9900cc] dark:hover:text-[#c000ff] transition-colors">FAQ</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium text-slate-500 dark:text-slate-400">
              <li><a href="#" className="hover:text-[#9900cc] dark:hover:text-[#c000ff] transition-colors">Comment vendre</a></li>
              <li><a href="#" className="hover:text-[#9900cc] dark:hover:text-[#c000ff] transition-colors">Conditions de rachat</a></li>
              <li><a href="#" className="hover:text-[#9900cc] dark:hover:text-[#c000ff] transition-colors">Tableau de bord</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium text-slate-500 dark:text-slate-400">
              <li><a href="#" className="hover:text-[#9900cc] dark:hover:text-[#c000ff] transition-colors">Qui sommes-nous ?</a></li>
              <li><a href="#" className="hover:text-[#9900cc] dark:hover:text-[#c000ff] transition-colors">S.A.V</a></li>
              <li><a href="#" className="hover:text-[#9900cc] dark:hover:text-[#c000ff] transition-colors">Mentions légales & CGV</a></li>
              <li><a href="#" className="hover:text-[#9900cc] dark:hover:text-[#c000ff] transition-colors">Nous contacter</a></li>
            </ul>
          </div>
